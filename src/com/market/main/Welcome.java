	...
	public static void menuAdminLogin() {
		...
		if (adminId.equals(admin.getId()) && adminPW.equals(admin.getPassword())) {
			...
			if (str.toUpperCase().equals("Y")) {
				...
				writBook[0] = "ISBN" + strDate;
				System.out.println("도서명 ID : " + writBook[0]);
				String str1 = input.nextLine();
				System.out.print("도서명 : ");
				writBook[1] = input.nextLine();
				System.out.print("가격 : ");
				writBook[2] = input.nextLine();
				System.out.print("저자 : ");
				writBook[3] = input.nextLine();
				System.out.print("설명 : ");
				writBook[4] = input.nextLine();
				System.out.print("분야 : ");
				writBook[5] = input.nextLine();
				System.out.print("출판일 : ");
				writBook[6] = input.nextLine();
				...
				try {
					...
					for (int i = 0; i < 7; i++)
						fw.write(writBook[i]+"\n");
						fw.close();
						System.out.println("새 도서 정보가 저장 되었습니다.");
				} catch (Exception e) {
